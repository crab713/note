...
[范式用法解析](https://www.cnblogs.com/hellcat/p/7979711.html)

**L0范式**：指向量中非零元素的个数（很难优化求解）

**L1范式**：向量中各个元素的绝对值之和（产生稀疏性，进行特征选择）

**L2范式**：向量中各元素的平方和然后求平方根（公式中两道竖线即为L2范式、泛化较好）
...
使用较低的learning rate预热，慢慢恢复到正常，该方法有可能提高模型的准确率
...
**深度图特点**：每个像素对应的值都是不同的，这是缺少语义信息的不对称现像，我们其实要在深度图上做一个处理，类似于二值化操作，聚类所有像素
